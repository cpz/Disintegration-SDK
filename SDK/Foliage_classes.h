...
public:
	...
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x07C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x03A8(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x03B4(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x03C0(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x03CC(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UProceduralFoliageSpawner*                   FoliageSpawner;                                           // 0x0128(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TileOverlap;                                              // 0x0130(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FGuid                                       ProceduralGuid;                                           // 0x0140(0x0010) (ZeroConstructor, IsPlainOldData)
