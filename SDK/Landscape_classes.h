...
public:
	...
	struct FGuid                                       LandscapeGuid;                                            // 0x0398(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   LandscapeSectionOffset;                                   // 0x03A8(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                MaxLODLevel;                                              // 0x03B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LODDistanceFactor;                                        // 0x03B4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	TEnumAsByte<ELandscapeLODFalloff>                  LODFalloff;                                               // 0x03B8(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03B9(0x0003) MISSED OFFSET
	float                                              ComponentScreenSizeToUseSubSections;                      // 0x03BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LOD0DistributionSetting;                                  // 0x03C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LODDistributionSetting;                                   // 0x03C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TessellationComponentScreenSize;                          // 0x03C8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UseTessellationComponentScreenSizeFalloff;                // 0x03CC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03CD(0x0003) MISSED OFFSET
	float                                              TessellationComponentScreenSizeFalloff;                   // 0x03D0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                OccluderGeometryLOD;                                      // 0x03D4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StaticLightingLOD;                                        // 0x03D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UMaterialInterface*                          LandscapeMaterial;                                        // 0x03F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          LandscapeHoleMaterial;                                    // 0x03F8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FLandscapeProxyMaterialOverride>     LandscapeMaterialsOverride;                               // 0x0400(0x0010) (Edit, ZeroConstructor)
	...
	unsigned char                                      UnknownData04[0x64];                                      // 0x0448(0x0064) MISSED OFFSET
	bool                                               bHasLandscapeGrass;                                       // 0x04AC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x04AD(0x0003) MISSED OFFSET
	float                                              StaticLightingResolution;                                 // 0x04B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCastStaticShadow : 1;                                    // 0x04B4(0x0001) (Edit)
	unsigned char                                      bCastShadowAsTwoSided : 1;                                // 0x04B4(0x0001) (Edit)
	unsigned char                                      bCastFarShadow : 1;                                       // 0x04B4(0x0001) (Edit)
	unsigned char                                      UnknownData06[0x3];                                       // 0x04B5(0x0003) MISSED OFFSET
	unsigned char                                      bAffectDistanceFieldLighting : 1;                         // 0x04B8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FLightingChannels                           LightingChannels;                                         // 0x04B9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData07[0x2];                                       // 0x04BA(0x0002) MISSED OFFSET
	unsigned char                                      bUseMaterialPositionOffsetInStaticLighting : 1;           // 0x04BC(0x0001) (Edit)
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x04BC(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData08[0x3];                                       // 0x04BD(0x0003) MISSED OFFSET
	int                                                CustomDepthStencilValue;                                  // 0x04C0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              LDMaxDrawDistance;                                        // 0x04C4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLightmassPrimitiveSettings                 LightmassSettings;                                        // 0x04C8(0x0018) (Edit)
	int                                                CollisionMipLevel;                                        // 0x04E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionMipLevel;                                  // 0x04E4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              CollisionThickness;                                       // 0x04E8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x04EC(0x0004) MISSED OFFSET
	struct FBodyInstance                               BodyInstance;                                             // 0x04F0(0x0148) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	unsigned char                                      UnknownData11[0x3];                                       // 0x0649(0x0003) MISSED OFFSET
	bool                                               bUseDynamicMaterialInstance;                              // 0x064C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x064D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x064E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x51];                                      // 0x064F(0x0051) MISSED OFFSET
...
{
public:
	bool                                               AffectHeightmap;                                          // 0x0390(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AffectWeightmap;                                          // 0x0391(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                ComponentSizeQuads;                                       // 0x05B0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x05B4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x05B8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x05BC(0x0004) MISSED OFFSET
	class UMaterialInterface*                          OverrideMaterial;                                         // 0x05C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OverrideHoleMaterial;                                     // 0x05C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FLandscapeComponentMaterialOverride> OverrideMaterials;                                        // 0x05D0(0x0010) (Edit, ZeroConstructor)
	TArray<class UMaterialInstanceConstant*>           materialInstances;                                        // 0x05E0(0x0010) (ZeroConstructor)
	TArray<class UMaterialInstanceDynamic*>            MaterialInstancesDynamic;                                 // 0x05F0(0x0010) (ZeroConstructor, Transient)
	TArray<int8_t>                                     LODIndexToMaterialIndex;                                  // 0x0600(0x0010) (ZeroConstructor)
	TArray<int8_t>                                     MaterialIndexToDisabledTessellationMaterial;              // 0x0610(0x0010) (ZeroConstructor)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                                // 0x0620(0x0010) (ZeroConstructor)
	TArray<class UTexture2D*>                          WeightmapTextures;                                        // 0x0630(0x0010) (ZeroConstructor)
	class UTexture2D*                                  XYOffsetmapTexture;                                       // 0x0640(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent> CollisionComponent;                                       // 0x069C(0x001C) (ExportObject, InstancedReference, IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x48];                                      // 0x0758(0x0048) MISSED OFFSET
...
public:
	...
	int                                                SectionBaseX;                                             // 0x05B8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SectionBaseY;                                             // 0x05BC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CollisionSizeQuads;                                       // 0x05C0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionScale;                                           // 0x05C4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionSizeQuads;                                 // 0x05C8(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x48];                                      // 0x0648(0x0048) MISSED OFFSET
...
public:
	...
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x0648(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0658(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x05B0(0x0008) MISSED OFFSET
	TArray<class ULandscapeSplineSegment*>             Segments;                                                 // 0x05B8(0x0010) (ZeroConstructor)
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                              // 0x05C8(0x0010) (ExportObject, ZeroConstructor)
...
{
public:
	TLazyObjectPtr<class ALandscape>                   LandscapeActor;                                           // 0x06A0(0x001C) (Edit, IsPlainOldData)
