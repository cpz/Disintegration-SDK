...
// WidgetBlueprintGeneratedClass FailureObjectiveNotificationWidget_BP.FailureObjectiveNotificationWidget_BP_C
// 0x0018 (0x0310 - 0x02F8)
class UFailureObjectiveNotificationWidget_BP_C : public UTextNotificationWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass FailureObjectiveNotificationWidget_BP.FailureObjectiveNotificationWidget_BP_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_FailureObjectiveNotificationWidget_BP(int* EntryPoint);
};
