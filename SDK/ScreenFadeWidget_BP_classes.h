...
// WidgetBlueprintGeneratedClass ScreenFadeWidget_BP.ScreenFadeWidget_BP_C
// 0x0008 (0x0500 - 0x04F8)
class UScreenFadeWidget_BP_C : public UScreenFadeWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ScreenFadeWidget_BP.ScreenFadeWidget_BP_C");
		return ptr;
	}
