...
// WidgetBlueprintGeneratedClass PostUpdateObjectiveNotificationWidget_BP.PostUpdateObjectiveNotificationWidget_BP_C
// 0x0018 (0x0310 - 0x02F8)
class UPostUpdateObjectiveNotificationWidget_BP_C : public UTextNotificationWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PostUpdateObjectiveNotificationWidget_BP.PostUpdateObjectiveNotificationWidget_BP_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_PostUpdateObjectiveNotificationWidget_BP(int* EntryPoint);
};
