...
// WidgetBlueprintGeneratedClass AfterPurchaseCurrencyFailMenuWidget_BP.AfterPurchaseCurrencyFailMenuWidget_BP_C
// 0x0020 (0x0388 - 0x0368)
class UAfterPurchaseCurrencyFailMenuWidget_BP_C : public UV1ElementMenu
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AfterPurchaseCurrencyFailMenuWidget_BP.AfterPurchaseCurrencyFailMenuWidget_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AfterPurchaseCurrencyFailMenuWidget_BP(int* EntryPoint);
};
