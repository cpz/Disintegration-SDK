...
{
public:
	struct FDropTimecode                               DropTimecode;                                             // 0x0290(0x001C) (BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData00[0x4];                                       // 0x02AC(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTimecodeChange;                                         // 0x02B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
