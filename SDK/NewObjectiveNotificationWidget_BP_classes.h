...
// WidgetBlueprintGeneratedClass NewObjectiveNotificationWidget_BP.NewObjectiveNotificationWidget_BP_C
// 0x0018 (0x0310 - 0x02F8)
class UNewObjectiveNotificationWidget_BP_C : public UTextNotificationWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass NewObjectiveNotificationWidget_BP.NewObjectiveNotificationWidget_BP_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_NewObjectiveNotificationWidget_BP(int* EntryPoint);
};
