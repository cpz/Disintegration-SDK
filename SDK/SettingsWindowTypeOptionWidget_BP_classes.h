...
// WidgetBlueprintGeneratedClass SettingsWindowTypeOptionWidget_BP.SettingsWindowTypeOptionWidget_BP_C
// 0x0020 (0x0438 - 0x0418)
class USettingsWindowTypeOptionWidget_BP_C : public USettingsWindowTypeOption
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SettingsWindowTypeOptionWidget_BP.SettingsWindowTypeOptionWidget_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SettingsWindowTypeOptionWidget_BP(int* EntryPoint);
};
