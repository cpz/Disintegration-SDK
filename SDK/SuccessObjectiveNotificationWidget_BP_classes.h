...
// WidgetBlueprintGeneratedClass SuccessObjectiveNotificationWidget_BP.SuccessObjectiveNotificationWidget_BP_C
// 0x0018 (0x0310 - 0x02F8)
class USuccessObjectiveNotificationWidget_BP_C : public UTextNotificationWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SuccessObjectiveNotificationWidget_BP.SuccessObjectiveNotificationWidget_BP_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_SuccessObjectiveNotificationWidget_BP(int* EntryPoint);
};
