...
{
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x0128(0x000C) MISSED OFFSET
	unsigned char                                      UnknownData01 : 1;                                        // 0x0134(0x0001)
	unsigned char                                      bIsNetDirty : 1;                                          // 0x0134(0x0001)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0135(0x0003) MISSED OFFSET
	TArray<class UGameplayTask*>                       SimulatedTasks;                                           // 0x0138(0x0010) (Net, ZeroConstructor)
	TArray<class UGameplayTask*>                       TaskPriorityQueue;                                        // 0x0148(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0158(0x0010) MISSED OFFSET
	TArray<class UGameplayTask*>                       TickingTasks;                                             // 0x0168(0x0010) (ZeroConstructor)
	TArray<class UGameplayTask*>                       KnownTasks;                                               // 0x0178(0x0010) (ZeroConstructor, Transient)
	struct FScriptMulticastDelegate                    OnClaimedResourcesChange;                                 // 0x0188(0x0010) (BlueprintVisible, ZeroConstructor, InstancedReference)
