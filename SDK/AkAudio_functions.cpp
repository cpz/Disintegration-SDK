...
void UAkGameplayStatics::STATIC_GetRTPCValue(struct FName* RTPC, int* playingId, ERTPCValueType* InputValueType, class AActor** Actor, float* Value, ERTPCValueType* OutputValueType)
{
...
class UAkComponent* UAkGameplayStatics::STATIC_GetAkComponent(class USceneComponent** AttachToComponent, struct FName* AttachPointName, struct FVector* Location, TEnumAsByte<EAttachLocation>* LocationType, bool* ComponentCreated)
{
