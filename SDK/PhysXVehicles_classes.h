...
public:
	...
	unsigned char                                      bDeprecatedSpringOffsetMode : 1;                          // 0x01B8(0x0001) (Edit)
	unsigned char                                      bReverseAsBrake : 1;                                      // 0x01B8(0x0001) (Edit)
	unsigned char                                      bUseRVOAvoidance : 1;                                     // 0x01B8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bRawHandbrakeInput : 1;                                   // 0x01B8(0x0001) (Transient)
	unsigned char                                      bRawGearUpInput : 1;                                      // 0x01B8(0x0001) (Transient)
	unsigned char                                      bRawGearDownInput : 1;                                    // 0x01B8(0x0001) (Transient)
	unsigned char                                      UnknownData01[0x3];                                       // 0x01B9(0x0003) MISSED OFFSET
	unsigned char                                      bWasAvoidanceUpdated : 1;                                 // 0x01BC(0x0001) (Transient)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01BD(0x0003) MISSED OFFSET
	float                                              Mass;                                                     // 0x01C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	float                                              DragCoefficient;                                          // 0x01D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisWidth;                                             // 0x01DC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisHeight;                                            // 0x01E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DragArea;                                                 // 0x01E4(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              EstimatedMaxEngineSpeed;                                  // 0x01E8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              MaxEngineRPM;                                             // 0x01EC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              DebugDragMagnitude;                                       // 0x01F0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     InertiaTensorScale;                                       // 0x01F4(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinNormalizedTireLoad;                                    // 0x0200(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinNormalizedTireLoadFiltered;                            // 0x0204(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxNormalizedTireLoad;                                    // 0x0208(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxNormalizedTireLoadFiltered;                            // 0x020C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ThresholdLongitudinalSpeed;                               // 0x0210(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                LowForwardSpeedSubStepCount;                              // 0x0214(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                HighForwardSpeedSubStepCount;                             // 0x0218(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x021C(0x0004) MISSED OFFSET
	TArray<class UVehicleWheel*>                       Wheels;                                                   // 0x0220(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData05[0x18];                                      // 0x0230(0x0018) MISSED OFFSET
	float                                              RVOAvoidanceRadius;                                       // 0x0248(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOAvoidanceHeight;                                       // 0x024C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceConsiderationRadius;                             // 0x0250(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOSteeringStep;                                          // 0x0254(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOThrottleStep;                                          // 0x0258(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AvoidanceUID;                                             // 0x025C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0260(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x0264(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0268(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceWeight;                                          // 0x026C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector                                     PendingLaunchVelocity;                                    // 0x0270(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FReplicatedVehicleState                     ReplicatedState;                                          // 0x027C(0x0014) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0290(0x0004) MISSED OFFSET
	float                                              RawSteeringInput;                                         // 0x0294(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawThrottleInput;                                         // 0x0298(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawBrakeInput;                                            // 0x029C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	...
	unsigned char                                      UnknownData07[0x24];                                      // 0x02DC(0x0024) MISSED OFFSET
	class AController*                                 OverrideController;                                       // 0x0300(0x0008) (Net, ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	struct FVehicleEngineData                          EngineSetup;                                              // 0x0308(0x00A0) (Edit)
	struct FVehicleDifferential4WData                  DifferentialSetup;                                        // 0x03A8(0x001C) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AckermannAccuracy;                                        // 0x03C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVehicleTransmissionData                    TransmissionSetup;                                        // 0x03C8(0x0030) (Edit)
	struct FRuntimeFloatCurve                          SteeringCurve;                                            // 0x03F8(0x0088) (Edit)
