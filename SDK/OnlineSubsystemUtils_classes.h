...
public:
	...
	unsigned char                                      UnknownData00[0x3F];                                      // 0x03D1(0x003F) MISSED OFFSET
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0440(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0450(0x0040)
	EClientRequestType                                 RequestType;                                              // 0x0490(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0491(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0492(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2D];                                      // 0x0493(0x002D) MISSED OFFSET
...
public:
	...
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0420(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0421(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0424(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0428(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
