...
{
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0128(0x0038) MISSED OFFSET
	...
	unsigned char                                      UnknownData02[0x158];                                     // 0x0178(0x0158) MISSED OFFSET
...
public:
	...
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x02D8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x02E0(0x000C) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0440(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0440(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0440(0x0001) (Edit, BlueprintVisible)
	...
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0478(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bAutoRegisterAsSource : 1;                                // 0x0128(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0129(0x0007) MISSED OFFSET
	TArray<class UClass*>                              RegisterAsSourceForSenses;                                // 0x0130(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0x120];                                     // 0x01B8(0x0120) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x30];                                      // 0x05B0(0x0030) MISSED OFFSET
...
{
public:
	class UEnvQuery*                                   QueryTemplate;                                            // 0x07B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x07B8(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x07C8(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x07D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x07DC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x07E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x07E1(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x07E4(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x07E4(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x07E4(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x07E4(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x07E4(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x07E5(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x07E8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x07E9(0x0007) MISSED OFFSET
	struct FNavAgentProperties                         NavAgentProperties;                                       // 0x07F0(0x0030) (Edit)
	unsigned char                                      UnknownData03[0x20];                                      // 0x0820(0x0020) MISSED OFFSET
...
public:
	...
	TArray<struct FNavigationLink>                     PointLinks;                                               // 0x03A0(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNavigationSegmentLink>              SegmentLinks;                                             // 0x03B0(0x0010) (ZeroConstructor)
	class UNavLinkCustomComponent*                     SmartLinkComp;                                            // 0x03C0(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	bool                                               bSmartLinkIsRelevant;                                     // 0x03C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x03C9(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSmartLinkReached;                                       // 0x03D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	class APawn*                                       ControlledPawn;                                           // 0x0128(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	float                                              HearingThreshold;                                         // 0x0128(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LOSHearingThreshold;                                      // 0x012C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SightRadius;                                              // 0x0130(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SensingInterval;                                          // 0x0134(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              HearingMaxSoundAge;                                       // 0x0138(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bEnableSensingUpdates : 1;                                // 0x013C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bOnlySensePlayers : 1;                                    // 0x013C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSeePawns : 1;                                            // 0x013C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bHearNoises : 1;                                          // 0x013C(0x0001) (Edit, BlueprintVisible)
	...
	float                                              PeripheralVisionAngle;                                    // 0x0168(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
